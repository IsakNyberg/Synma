...
class SynthGUI {
	...
	constructor(urlPresets,waveGraphCanvas,envelopeGraphCanvas) {
		this.waveGraphCanvas = waveGraphCanvas; // GUI
		this.envelopeGraphCanvas = envelopeGraphCanvas; // GUI
	...
	// SO MANY ARGUMENTS! WHERE D FUG IS MY PARSER AND ENVELOPE MODULES!
	/**
	...
	// FUG NO! WHERE IS MY RENDERER MODULE? I DONT WANT TO DO ALL THIS WORK!
	/**
